...
*/var hn,Pp,di,as,ls,Pa,uS,$s,Gl,cS,Nr,ji,fS,dS=function(){return hn||typeof window<"u"&&(hn=window.gsap)&&hn.registerPlugin&&hn},hS=1,xa=[],it=[],hr=[],Vl=Date.now,Lp=function(e,t){return t},Ew=function(){var e=Gl.core,t=e.bridge||{},i=e._scrollers,r=e._proxies;i.push.apply(i,it),r.push.apply(r,hr),it=i,hr=r,Lp=function(o,a){return t[o](a)}},Ms=function(e,t){return~hr.indexOf(e)&&hr[hr.indexOf(e)+1][t]},Wl=function(e){return!!~cS.indexOf(e)},Dn=function(e,t,i,r,s){return e.addEventListener(t,i,{passive:!r,capture:!!s})},Ln=function(e,t,i,r){return e.removeEventListener(t,i,!!r)},nc="scrollLeft",ic="scrollTop",Dp=function(){return Nr&&Nr.isPressed||it.cache++},Lf=function(e,t){var i=function r(s){if(s||s===0){hS&&(di.history.scrollRestoration="manual");var o=Nr&&Nr.isPressed;s=r.v=Math.round(s)||(Nr&&Nr.iOS?1:0),e(s),r.cacheID=it.cache,o&&Lp("ss",s)}else(t||it.cache!==r.cacheID||Lp("ref"))&&(r.cacheID=it.cache,r.v=e());return r.v+r.offset};return i.offset=0,e&&i},Bn={s:nc,p:"left",p2:"Left",os:"right",os2:"Right",d:"width",d2:"Width",a:"x",sc:Lf(function(n){return arguments.length?di.scrollTo(n,Kt.sc()):di.pageXOffset||as[nc]||ls[nc]||Pa[nc]||0})},Kt={s:ic,p:"top",p2:"Top",os:"bottom",os2:"Bottom",d:"height",d2:"Height",a:"y",op:Bn,sc:Lf(function(n){return arguments.length?di.scrollTo(Bn.sc(),n):di.pageYOffset||as[ic]||ls[ic]||Pa[ic]||0})},Xn=function(e,t){return(t&&t._ctx&&t._ctx.selector||hn.utils.toArray)(e)[0]||(typeof e=="string"&&hn.config().nullTargetWarn!==!1?console.warn("Element not found:",e):null)},Ps=function(e,t){var i=t.s,r=t.sc;Wl(e)&&(e=as.scrollingElement||ls);var s=it.indexOf(e),o=r===Kt.sc?1:2;!~s&&(s=it.push(e)-1),it[s+o]||Dn(e,"scroll",Dp);var a=it[s+o],l=a||(it[s+o]=Lf(Ms(e,i),!0)||(Wl(e)?r:Lf(function(u){return arguments.length?e[i]=u:e[i]})));return l.target=e,a||(l.smooth=hn.getProperty(e,"scrollBehavior")==="smooth"),l},Up=function(e,t,i){var r=e,s=e,o=Vl(),a=o,l=t||50,u=Math.max(500,l*3),c=function(g,_){var m=Vl();_||m-o>l?(s=r,r=g,a=o,o=m):i?r+=g:r=s+(g-s)/(m-a)*(o-a)},d=function(){s=r=i?0:r,a=o=0},f=function(g){var _=a,m=s,h=Vl();return(g||g===0)&&g!==r&&c(g),o===a||h-a>u?0:(r+(i?m:-m))/((i?h:o)-_)*1e3};return{update:c,reset:d,getVelocity:f}},_l=function(e,t){return t&&!e._gsapAllow&&e.preventDefault(),e.changedTouches?e.changedTouches[0]:e},qg=function(e){var t=Math.max.apply(Math,e),i=Math.min.apply(Math,e);return Math.abs(t)>=Math.abs(i)?t:i},pS=function(){Gl=hn.core.globals().ScrollTrigger,Gl&&Gl.core&&Ew()},mS=function(e){return hn=e||dS(),hn&&typeof document<"u"&&document.body&&(di=window,as=document,ls=as.documentElement,Pa=as.body,cS=[di,as,ls,Pa],hn.utils.clamp,fS=hn.core.context||function(){},$s="onpointerenter"in Pa?"pointer":"mouse",uS=jt.isTouch=di.matchMedia&&di.matchMedia("(hover: none), (pointer: coarse)").matches?1:"ontouchstart"in di||navigator.maxTouchPoints>0||navigator.msMaxTouchPoints>0?2:0,ji=jt.eventTypes=("ontouchstart"in ls?"touchstart,touchmove,touchcancel,touchend":"onpointerdown"in ls?"pointerdown,pointermove,pointercancel,pointerup":"mousedown,mousemove,mouseup,mouseup").split(","),setTimeout(function(){return hS=0},500),pS(),Pp=1),Pp};Bn.op=Kt;it.cache=0;var jt=function(){function n(t){this.init(t)}var e=n.prototype;return e.init=function(i){Pp||mS(hn)||console.warn("Please gsap.registerPlugin(Observer)"),Gl||pS();var r=i.tolerance,s=i.dragMinimum,o=i.type,a=i.target,l=i.lineHeight,u=i.debounce,c=i.preventDefault,d=i.onStop,f=i.onStopDelay,p=i.ignore,g=i.wheelSpeed,_=i.event,m=i.onDragStart,h=i.onDragEnd,v=i.onDrag,x=i.onPress,y=i.onRelease,E=i.onRight,w=i.onLeft,M=i.onUp,P=i.onDown,S=i.onChangeX,T=i.onChangeY,j=i.onChange,z=i.onToggleX,I=i.onToggleY,F=i.onHover,k=i.onHoverEnd,J=i.onMove,O=i.ignoreCheck,U=i.isNormalizer,W=i.onGestureStart,C=i.onGestureEnd,N=i.onWheel,H=i.onEnable,ue=i.onDisable,re=i.onClick,fe=i.scrollSpeed,ve=i.capture,ye=i.allowClicks,Ee=i.lockAxis,Be=i.onLockAxis;this.target=a=Xn(a)||ls,this.vars=i,p&&(p=hn.utils.toArray(p)),r=r||1e-9,s=s||0,g=g||1,fe=fe||1,o=o||"wheel,touch,pointer",u=u!==!1,l||(l=parseFloat(di.getComputedStyle(Pa).lineHeight)||22);var gt,Ne,G,Fe,xe,De,Le,q=this,ke=0,ze=0,qe=Ps(a,Bn),Ke=Ps(a,Kt),vt=qe(),b=Ke(),A=~o.indexOf("touch")&&!~o.indexOf("pointer")&&ji[0]==="pointerdown",X=Wl(a),te=a.ownerDocument||as,ne=[0,0,0],se=[0,0,0],Ae=0,oe=function(){return Ae=Vl()},Z=function(ge,We){return(q.event=ge)&&p&&~p.indexOf(ge.target)||We&&A&&ge.pointerType!=="touch"||O&&O(ge,We)},L=function(){q._vx.reset(),q._vy.reset(),Ne.pause(),d&&d(q)},ee=function(){var ge=q.deltaX=qg(ne),We=q.deltaY=qg(se),Qe=Math.abs(ge)>=r,Se=Math.abs(We)>=r;j&&(Qe||Se)&&j(q,ge,We,ne,se),Qe&&(E&&q.deltaX>0&&E(q),w&&q.deltaX<0&&w(q),S&&S(q),z&&q.deltaX<0!=ke<0&&z(q),ke=q.deltaX,ne[0]=ne[1]=ne[2]=0),Se&&(P&&q.deltaY>0&&P(q),M&&q.deltaY<0&&M(q),T&&T(q),I&&q.deltaY<0!=ze<0&&I(q),ze=q.deltaY,se[0]=se[1]=se[2]=0),(Fe||G)&&(J&&J(q),G&&(v(q),G=!1),Fe=!1),De&&!(De=!1)&&Be&&Be(q),xe&&(N(q),xe=!1),gt=0},pe=function(ge,We,Qe){ne[Qe]+=ge,se[Qe]+=We,q._vx.update(ge),q._vy.update(We),u?gt||(gt=requestAnimationFrame(ee)):ee()},ce=function(ge,We){Ee&&!Le&&(q.axis=Le=Math.abs(ge)>Math.abs(We)?"x":"y",De=!0),Le!=="y"&&(ne[2]+=ge,q._vx.update(ge,!0)),Le!=="x"&&(se[2]+=We,q._vy.update(We,!0)),u?gt||(gt=requestAnimationFrame(ee)):ee()},he=function(ge){if(!Z(ge,1)){ge=_l(ge,c);var We=ge.clientX,Qe=ge.clientY,Se=We-q.x,nt=Qe-q.y,He=q.isDragging;q.x=We,q.y=Qe,(He||Math.abs(q.startX-We)>=s||Math.abs(q.startY-Qe)>=s)&&(v&&(G=!0),He||(q.isDragging=!0),ce(Se,nt),He||m&&m(q))}},Ie=q.onPress=function(Ue){Z(Ue,1)||Ue&&Ue.button||(q.axis=Le=null,Ne.pause(),q.isPressed=!0,Ue=_l(Ue),ke=ze=0,q.startX=q.x=Ue.clientX,q.startY=q.y=Ue.clientY,q._vx.reset(),q._vy.reset(),Dn(U?a:te,ji[1],he,c,!0),q.deltaX=q.deltaY=0,x&&x(q))},Ve=q.onRelease=function(Ue){if(!Z(Ue,1)){Ln(U?a:te,ji[1],he,!0);var ge=!isNaN(q.y-q.startY),We=q.isDragging&&(Math.abs(q.x-q.startX)>3||Math.abs(q.y-q.startY)>3),Qe=_l(Ue);!We&&ge&&(q._vx.reset(),q._vy.reset(),c&&ye&&hn.delayedCall(.08,function(){if(Vl()-Ae>300&&!Ue.defaultPrevented){if(Ue.target.click)Ue.target.click();else if(te.createEvent){var Se=te.createEvent("MouseEvents");Se.initMouseEvent("click",!0,!0,di,1,Qe.screenX,Qe.screenY,Qe.clientX,Qe.clientY,!1,!1,!1,!1,0,null),Ue.target.dispatchEvent(Se)}}})),q.isDragging=q.isGesturing=q.isPressed=!1,d&&!U&&Ne.restart(!0),h&&We&&h(q),y&&y(q,We)}},D=function(ge){return ge.touches&&ge.touches.length>1&&(q.isGesturing=!0)&&W(ge,q.isDragging)},de=function(){return(q.isGesturing=!1)||C(q)},K=function(ge){if(!Z(ge)){var We=qe(),Qe=Ke();pe((We-vt)*fe,(Qe-b)*fe,1),vt=We,b=Qe,d&&Ne.restart(!0)}},ie=function(ge){if(!Z(ge)){ge=_l(ge,c),N&&(xe=!0);var We=(ge.deltaMode===1?l:ge.deltaMode===2?di.innerHeight:1)*g;pe(ge.deltaX*We,ge.deltaY*We,0),d&&!U&&Ne.restart(!0)}},ae=function(ge){if(!Z(ge)){var We=ge.clientX,Qe=ge.clientY,Se=We-q.x,nt=Qe-q.y;q.x=We,q.y=Qe,Fe=!0,(Se||nt)&&ce(Se,nt)}},Ge=function(ge){q.event=ge,F(q)},st=function(ge){q.event=ge,k(q)},ot=function(ge){return Z(ge)||_l(ge,c)&&re(q)};Ne=q._dc=hn.delayedCall(f||.25,L).pause(),q.deltaX=q.deltaY=0,q._vx=Up(0,50,!0),q._vy=Up(0,50,!0),q.scrollX=qe,q.scrollY=Ke,q.isDragging=q.isGesturing=q.isPressed=!1,fS(this),q.enable=function(Ue){return q.isEnabled||(Dn(X?te:a,"scroll",Dp),o.indexOf("scroll")>=0&&Dn(X?te:a,"scroll",K,c,ve),o.indexOf("wheel")>=0&&Dn(a,"wheel",ie,c,ve),(o.indexOf("touch")>=0&&uS||o.indexOf("pointer")>=0)&&(Dn(a,ji[0],Ie,c,ve),Dn(te,ji[2],Ve),Dn(te,ji[3],Ve),ye&&Dn(a,"click",oe,!1,!0),re&&Dn(a,"click",ot),W&&Dn(te,"gesturestart",D),C&&Dn(te,"gestureend",de),F&&Dn(a,$s+"enter",Ge),k&&Dn(a,$s+"leave",st),J&&Dn(a,$s+"move",ae)),q.isEnabled=!0,Ue&&Ue.type&&Ie(Ue),H&&H(q)),q},q.disable=function(){q.isEnabled&&(xa.filter(function(Ue){return Ue!==q&&Wl(Ue.target)}).length||Ln(X?te:a,"scroll",Dp),q.isPressed&&(q._vx.reset(),q._vy.reset(),Ln(U?a:te,ji[1],he,!0)),Ln(X?te:a,"scroll",K,ve),Ln(a,"wheel",ie,ve),Ln(a,ji[0],Ie,ve),Ln(te,ji[2],Ve),Ln(te,ji[3],Ve),Ln(a,"click",oe,!0),Ln(a,"click",ot),Ln(te,"gesturestart",D),Ln(te,"gestureend",de),Ln(a,$s+"enter",Ge),Ln(a,$s+"leave",st),Ln(a,$s+"move",ae),q.isEnabled=q.isPressed=q.isDragging=!1,ue&&ue(q))},q.kill=q.revert=function(){q.disable();var Ue=xa.indexOf(q);Ue>=0&&xa.splice(Ue,1),Nr===q&&(Nr=0)},xa.push(q),U&&Wl(a)&&(Nr=q),q.enable(_)},Mw(n,[{key:"velocityX",get:function(){return this._vx.getVelocity()}},{key:"velocityY",get:function(){return this._vy.getVelocity()}}]),n}();jt.version="3.12.2";jt.create=function(n){return new jt(n)};jt.register=mS;jt.getAll=function(){return xa.slice()};jt.getById=function(n){return xa.filter(function(e){return e.vars.id===n})[0]};dS()&&hn.registerPlugin(jt);/*!
